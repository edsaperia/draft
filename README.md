...
Spec v0.86. The mechanism (engine-core, 271 tests) and the constitutional layer (627 tests) are built and tested; the server (81 tests, 14 more against Postgres) hosts real documents at docs.vote; the simulator (31 tests) is what keeps all of it honest.
