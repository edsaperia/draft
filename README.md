...
TypeScript end to end; `pg` is the only runtime dependency. Tests measured 2026-09-19 with `npm test`: **1,388 passing** (9 todo, 18 skipped without Postgres).
...
|---|---|---|
| [`SPEC.md`](SPEC.md) | The mechanism, v0.137 — tables and numbered rules, each pointing at its reasons as `→ why: R-nnn`. The single source of truth. | First, to understand what the engine does. |
