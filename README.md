...
Spec v0.97. The mechanism (engine-core, 286 tests) and the constitutional layer (674 tests) are built and tested; the server (99 tests, 14 more against Postgres) hosts real documents at docs.vote; the simulator (32 tests) is what keeps all of it honest.
