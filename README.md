...
- **[SPEC.md](SPEC.md)** — the specification (currently v0.91), single source of truth for the mechanism.
...
Spec v0.91. The mechanism (engine-core, 277 tests) and the constitutional layer (670 tests) are built and tested; the server (99 tests, 14 more against Postgres) hosts real documents at docs.vote; the simulator (31 tests) is what keeps all of it honest.
