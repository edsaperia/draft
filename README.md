...
- **[SPEC.md](SPEC.md)** — the specification (currently v0.84), single source of truth for the mechanism.
...
Spec v0.84. The mechanism (engine-core, 271 tests) and the constitutional layer (627 tests) are built and tested; the server (81 tests, 14 more against Postgres) hosts real documents at docs.vote; the simulator (31 tests) is what keeps all of it honest.
