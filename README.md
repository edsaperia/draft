...
TypeScript end to end; `pg` is the only runtime dependency. Tests measured 2026-09-19 with `npm test`: **1,353 passing** (9 todo, 18 skipped without Postgres).
