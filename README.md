...
- **[SPEC.md](SPEC.md)** — the specification (currently v0.71), single source of truth for the mechanism.
...
Spec v0.71. The mechanism (engine-core, 219 tests) and the constitutional layer (215 tests) are built and tested; the server (43 tests, 14 more against Postgres) hosts real documents at docs.vote; the simulator (31 tests) is what keeps all of it honest.
