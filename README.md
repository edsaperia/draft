...
Spec v0.76. The mechanism (engine-core, 222 tests) and the constitutional layer (237 tests) are built and tested; the server (44 tests, 14 more against Postgres) hosts real documents at docs.vote; the simulator (31 tests) is what keeps all of it honest.
