...
|---|---|---|
| [`SPEC.md`](SPEC.md) | The mechanism, v0.104 — tables and numbered rules, each pointing at its reasons as `→ why: R-nnn`. The single source of truth. | First, to understand what the engine does. |
