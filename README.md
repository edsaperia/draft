...
- **[SPEC.md](SPEC.md)** — the specification (currently v0.97), single source of truth for the mechanism.
...
Spec v0.97. The mechanism (engine-core, 289 tests) and the constitutional layer (677 tests) are built and tested; the server (99 tests, 14 more against Postgres) hosts real documents at docs.vote; the simulator (32 tests) is what keeps all of it honest.
