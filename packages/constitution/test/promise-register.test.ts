 ...
 * | **resignation** | `resign` works, except for the convenor, who unticks 🎩 instead | free, immediate, nobody's to refuse, **the convenor included** (entry 248) — and the seat they vacate is R-060's vacancy. Surface: *Leave* on your own row | `requireOpen` — *resigning is over*. §4.6: nothing changes but the signing, so this is a **kept** promise of the third epoch |
