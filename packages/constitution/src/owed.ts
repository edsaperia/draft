 ...
 * E32, E38). Exiled by ❌'s ✒️, removed by a carried 🥾 motion, or resigned:
 ...
 * rules otherwise, and `seat-matrix`'s E38 cell is the other half of it.
 *
...
/**
 * The OK on one departure (SURFACE E31, E32, E38) — `ackRelease`'s posture
