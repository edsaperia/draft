...
Next unused number: 50 (30, 33-41, 44-47; 48 resolved 2026-08-14 — no keep-current on rival cards, rival pairs gated on displacement evidence, folded into SPEC §8.3 were ephemeral chat items, 2026-08-13/14; 46 — diagonal-card visual distinction, likely a colour tint — is parked to decide with the palette work).
