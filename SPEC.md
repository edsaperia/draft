...
| Adoption floor F | max(1, Q′) **approvals** of the leader (§4.2), where Q′ is the settled quorum (§9.0a) read against the group the leader is waiting on and never more than half of it; the built-in ⌈E/3⌉ minimum went at v0.133 (R-131) | `adoptionFloorMax` = 12 · retained for replay, read by nothing |
