...
4. **The road back is a constitutional `reserve` motion**, naming one power or both (default both), landing **without** the convenor's assent — a lapsed convenor included (the surface offers it on the power's own tab, one power named: SURFACE E39, K32). → why: R-008
