# Group Drafting Engine — Specification v0.109
...
| **lapse** | 💤's quiet spell, on the clock (§9.5a) | nobody — it is a reading of the rule and no act of anyone's | when the clock says, warnings by mail first | keep counting | logging in, and nothing else; the reading is re-read when 💤 changes |
