# Group Drafting Engine — Specification v0.117
...
| 9.6 | Rival constitutional values that both carry are decided by the engine's preference race, never by order | nothing; a carried motion sets the value at once and ground-shifts its rival — the interim between the first carrying and the second is Q1348's open half |
