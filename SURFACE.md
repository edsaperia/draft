...
| power cards ✒️ 🛡️ | the power tabs | the power's rule as it stands | why · two proposal blocks, the rule at document size with its consequence · *Choose this / Chosen* | Choose this / Chosen (CP2) | 🗑️ | ✒️ (founder; not pen-gated, Y7) | ✒️ | the tab stays |
