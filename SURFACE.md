...
- **CP7 🗑️ on every card but Y20's five** (Q1102): judgment cards included — C4 wins; on a judgment 🗑️ clears the selection and closes. Whether quick/race/patch/diagonal actually lack it is the census's first finding; §9's table rows follow the fix.
