...
| `adm:` an admission | the *Applicants* pile, one card per applicant; **a task at *assembly* and *proposal*, news at *pen*** | the applicant — face, name, address, and their own words | **three forms, by 🪪's price**: at *proposal* the judgment *Admit them* / *Keep the membership as it is* / Indifferent; at *assembly* the consent picks and the blind note, on the same motion machinery as any other 🏛️ question; at *pen* one sentence saying they are already a member | by form | 🗑️ | ✓, or **OK** where it is news | ✓ / OK | the race's own marks |
