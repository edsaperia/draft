...
- **T18 · Decided is a word, not a glyph**: *OK* on anything that only wants
  ...
  accepted, not seen, so its commit reads *Accept ‹glyph›* — 🏛️'s *Activate
  🏛️* (Q1502) — and only an accepted grant's close is *OK* (T44).
