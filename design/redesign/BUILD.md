...
- **Kinds:** news of a change, failed-motion news, and the four live-only news families (release batch, amendment news, mail give-up, departure news — never reached in phase one); the grants and the gates 💡 ⚖️; the park; 🍾 in every state (**its label waits on Q1542** — see §6); the stranger's read-only cards.
