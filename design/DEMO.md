...
- **1535 (g) — The size ceiling.** *Recommend:* the demo resets itself past 20,000 log entries (a busy hour is a few thousand). *Alternative:* no ceiling; Ed resets by hand.
